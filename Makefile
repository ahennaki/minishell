...
#    Updated: 2023/07/16 06:12:18 by aennaki          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = libft/ft_atoi.c libft/ft_calloc.c libft/ft_itoa.c libft/ft_lstadd_back.c \
	...
	libft/ft_strlen.c libft/ft_strtrim.c libft/ft_strrchr.c libft/ft_substr.c main.c \
	init_env.c parsing.c tokenize.c
